...
from Efficient_SH_with_manifold_ours import ESH_manifold
...
# Learning W matrix
W = ESH_manifold(train_features, Z, K=K, maxiter=10000, W=orth(np.random.rand(train_features.shape[1],K)))
